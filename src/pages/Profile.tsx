    ...
    <div className="min-h-screen pt-24 pb-12 px-6">
      <div className="max-w-4xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          <div>
            <h1 className="text-3xl font-bold mb-1">Tu Plan de Entrenamiento</h1>
            <p className="text-[var(--color-muted)]">
              Version {plan.version} • Creado {formatDate(plan.createdAt)}
            </p>
          </div>
        ...
        <div className="grid md:grid-cols-4 gap-4 mb-8">
          ...
          <Card variant="bordered" className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs text-[var(--color-muted)]">Frecuencia</p>
        ...
        <Card variant="bordered" className="mb-8">
          <h2 className="font-semibold text-lg mb-2">Notas del programa</h2>
        ...
        {/* Weekly Schedule */}
        <h2 className="font-semibold text-xl mb-4">Horario semanal</h2>
        <PlanDisplay weeklySchedule={plan.weeklySchedule} />

        <Card variant="bordered" className="mb-8">
          <h2 className="font-semibold text-lg mb-2">Estrategia de progresión</h2>
          <p className="text-[var(--color-muted)] text-sm leading-relaxed">
            {plan.progression}
          </p>
        </Card>
