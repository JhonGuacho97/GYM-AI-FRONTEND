    ...
    <Card variant="bordered" className="overflow-hidden">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-2 text-sm text-[var(--color-muted)]">
          ...
          <span>{schedule.exercises.length} Ejercicios</span>
        </div>
      </div>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="text-[var(--color-muted)] text-xs uppercase tracking-wider">
              <th className="text-left py-2 pr-4 font-medium">Ejercicio</th>
              <th className="py-2 px-4 font-medium">Sets x Reps</th>
              <th className="py-2 px-4 font-medium">Descanso</th>
              <th className="py-2 px-4 font-medium">Tasa de Esfuerzo</th>
            </tr>
          </thead>
